...
export default function RegisterPage() {
  ...
  const errorIcon = <HugeiconsIcon icon={AlertCircleIcon} size={14} className="shrink-0" />;
        ...
        <div className="rounded-xl border border-paper-100 bg-paper-0 p-8 shadow-sm">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <Button
              type="submit"
              disabled={isLoading}
              className="h-11 w-full rounded-lg bg-ink-700 text-sm font-medium text-paper-0 hover:bg-ink-500 disabled:bg-paper-100 disabled:text-paper-500">
          ...
          <Button
            ...
            className="h-11 w-full rounded-lg text-sm font-medium text-paper-900 hover:bg-paper-50 gap-2">
